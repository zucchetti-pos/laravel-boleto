...
class Sicredi extends AbstractRemessa implements RemessaContract
{
    ...
    protected function header()
    {
        ...
        $this->add(32, 45, Util::formatCnab('AL', $this->getBeneficiario()->getDocumento(), 14, 0, 0));
        $this->add(46, 76, '');
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        $this->add(340, 353, $boleto->getSacadorAvalista() ? Util::formatCnab('AL', $boleto->getSacadorAvalista()->getDocumento(), 14) : Util::formatCnab('X', '', 14));
