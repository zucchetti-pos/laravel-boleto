...
class Santander extends AbstractRemessa implements RemessaContract
{
    ...
    public function segmentoQ(BoletoContract $boleto)
    {
        ...
        $this->add(18, 18, strlen(Util::onlyUpperAlphaNumeric($boleto->getPagador()->getDocumento())) == 14 ? 2 : 1);
        $this->add(19, 33, Util::formatCnab('9', Util::onlyUpperAlphaNumeric($boleto->getPagador()->getDocumento()), 15));
        ...
        if ($boleto->getSacadorAvalista()) {
            $this->add(154, 154, strlen(Util::onlyUpperAlphaNumeric($boleto->getSacadorAvalista()->getDocumento())) == 14 ? 2 : 1);
            $this->add(155, 169, Util::formatCnab('9', Util::onlyUpperAlphaNumeric($boleto->getSacadorAvalista()->getDocumento()), 15));
    ...
    public function segmentoR(BoletoContract $boleto)
    {
        ...
        $this->add(75, 89, Util::formatCnab('9', ($boleto->getMulta() * 100), 15, 2));  //2,20 = 0000000000220
        $this->add(90, 240, '');
    ...
    protected function header()
    {
        ...
        $this->add(8, 8, '0');
        $this->add(9, 16, '');
        $this->add(17, 17, strlen(Util::onlyUpperAlphaNumeric($this->getBeneficiario()->getDocumento())) == 14 ? '2' : '1');
        $this->add(18, 32, Util::formatCnab('9', Util::onlyUpperAlphaNumeric($this->getBeneficiario()->getDocumento()), 15));
    ...
    {
        if ($this->getCodigoTransmissaoCustomizado()) {
            return $this->getCodigoTransmissaoCustomizado();
        }
    ...
    protected function headerLote()
    {
        ...
        $this->add(17, 17, '');
        $this->add(18, 18, strlen(Util::onlyUpperAlphaNumeric($this->getBeneficiario()->getDocumento())) == 14 ? '2' : '1');
        $this->add(19, 33, Util::formatCnab('9', Util::onlyUpperAlphaNumeric($this->getBeneficiario()->getDocumento()), 15));
        $this->add(34, 53, '');
